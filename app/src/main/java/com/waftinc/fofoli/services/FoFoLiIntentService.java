...
public class FoFoLiIntentService extends IntentService {
    private static final String TAG = FoFoLiIntentService.class.getSimpleName();


    private static final String ACTION_UPDATE_WIDGETS = "com.waftinc.fofoli.action.update_widgets";
